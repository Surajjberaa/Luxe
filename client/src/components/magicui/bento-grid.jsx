...
const BentoCard = ({
  ...
  <div
    key={name}
    className={cn(
      "group relative col-span-3 flex flex-col justify-end gap-2 overflow-hidden rounded-xl",
      // light styles
    ...
    {...props}>
    <div className="absolute h-full">{background}</div>
    <div
      ...
      <h3 className="text-xl font-semibold text-neutral-700 dark:text-neutral-300 z-10">
        {name}
      </h3>
