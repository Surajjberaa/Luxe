...
export function Buggati(props) {
  const { nodes, materials } = useGLTF('https://gaapupgzgvpsestztgyn.supabase.co/storage/v1/object/sign/car-models/BuggatiTourbillionC.glb?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJjYXItbW9kZWxzL0J1Z2dhdGlUb3VyYmlsbGlvbkMuZ2xiIiwiaWF0IjoxNzQ0Mzc1NzYwLCJleHAiOjIwNTk3MzU3NjB9.VNCwQaG__LeCSFlb3X3pmA1JNMxJqhW8csXvo4q7lRc')
...
//   }, [])
  ...
  return (
    <group {...props} dispose={null} position={[0,-1,-.5]} rotation={[1.58,0,1]} ref={ref}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={90}>
        <group scale={0.01}>
          <mesh
            castShadow
            receiveShadow
          ...
          <group position={[-0.825, 0.351, 1.287]} rotation={[Math.PI, 0, -3.115]}>
            <group rotation={[0, 0, Math.PI]} scale={-1}>
              <mesh
                castShadow
                receiveShadow
