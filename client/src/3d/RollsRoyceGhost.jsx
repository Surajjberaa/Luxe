      ...
      <group scale={0.01}>
        ...
        <group position={[-1.616, 89.775, -101.825]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          ...
          <mesh
            ...
            material={materials['rrghost_belt.001']}
          />
          <mesh
            castShadow
            receiveShadow
          ...
          <mesh
            ...
            material={materials['rrghost_carpet.001']}
          />
          <mesh
            castShadow
            receiveShadow
          ...
          <mesh
            ...
            material={materials['rrghost_glass.001']}
          />
          <mesh
            castShadow
            receiveShadow
          ...
          <mesh
            ...
            material={materials['rrghost_interior.001']}
          />
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.rrghost_body_rrghost_interior_alpha_0.geometry}
            material={materials['rrghost_interior_alpha.001']}
          />
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.rrghost_body_rrghost_leatherblue_0.geometry}
            material={materials['rrghost_leatherblue.001']}
          />
          <mesh
            castShadow
            receiveShadow
          ...
          <mesh
            ...
            material={materials['rrghost_leatherlight.001']}
          />
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.rrghost_body_rrghost_main_0.geometry}
            material={materials['rrghost_main.001']}
          />
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.rrghost_body_rrghost_main_b001_0.geometry}
            material={materials['rrghost_main_b.002']}
          />
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-8.722, 77.197, 12.717]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          ...
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.rrghost_dash_rrghost_main_0001.geometry}
            material={materials.rrghost_main}
          />
          <mesh
            castShadow
        ...
        <group position={[-39.52, 87.21, 17.055]} rotation={[-2.891, 0, 0]} scale={100}>
          ...
          <mesh
            castShadow
            receiveShadow
            geometry={nodes['rrghost_steer_����������������_'].geometry}
        ...
        <mesh
          ...
          material={materials['etk_engine_i6.001']}
...
useGLTF.preload('https://gaapupgzgvpsestztgyn.supabase.co/storage/v1/object/sign/car-models/RollsRoyceGhost.glb?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJjYXItbW9kZWxzL1JvbGxzUm95Y2VHaG9zdC5nbGIiLCJpYXQiOjE3NDQzNzUxOTgsImV4cCI6MjA1OTczNTE5OH0.BWwKm6hNBcUKpB-KcI--3pHVRe9aONaO_144gvb9lU0')